...
class ModalDPClusterTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.mix = ModalDPMixture(
            [self.clst1, self.clst2, self.clst3],
            {0: [0, 1], 1: [2]},
            {0: self.mu1, 1: self.mu2})
    ...
    def test_classify(self):
        ...
        ).tolist() == [0,1,0,1,0,1], 'classify not working'
    ...
    def testarith(self):
        ...
        self.assertIsInstance(d, ModalDPMixture, 'array multiplication return wrong type')
